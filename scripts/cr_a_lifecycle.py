#!/usr/bin/env python3
# coding=utf-8
"""CR-A lifecycle janitor (J2) — standalone tool.
...
This script is standalone: it is never imported by runtime.  It talks
only to versioned file contracts through public boundaries.
