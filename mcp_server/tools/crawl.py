"""Crawl execution and optional persistence for the MCP server."""
...
class CrawlTools:
    """Execute one-off crawls without coupling them to system management."""
    ...
    def trigger_crawl(
        ...
        try:
            ...
            if save_to_local:
                ...
                try:
                    save_success, save_error_msg, saved_files = (
                        self._persist_crawl_data(
                            storage,
                            news_data,
                            save_to_local,
                            results,
                    ...
                    get_cache().clear()
                    logger.info("Cleared MCP cache after crawl persistence")
                    storage.cleanup()
