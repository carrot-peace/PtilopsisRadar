...
class SourceBudgetTests(unittest.TestCase):
    ...
    def test_refactored_hotspots_have_stricter_budgets(self):
        budgets = {
            ...
            "mcp_server/context.py": 180,
            "mcp_server/server.py": 190,
            "mcp_server/cli.py": 90,
            "mcp_server/domain/text.py": 100,
            "mcp_server/presentation.py": 75,
            "mcp_server/transport.py": 120,
            "mcp_server/features/analysis_search.py": 450,
            "mcp_server/features/crawl.py": 100,
            "mcp_server/features/management.py": 120,
            "mcp_server/features/query.py": 300,
            "mcp_server/features/reader.py": 150,
            "mcp_server/features/storage.py": 150,
            "mcp_server/services/remote_pull_service.py": 120,
            "mcp_server/tools/crawl.py": 400,
            "mcp_server/tools/data_query.py": 550,
            "mcp_server/tools/search_tools.py": 910,
            "mcp_server/tools/storage_sync.py": 560,
            "mcp_server/tools/system.py": 275,
            "mcp_server/tools/analytics.py": 150,
            "mcp_server/tools/article_reader.py": 250,
