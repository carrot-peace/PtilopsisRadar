...
class TestLegacyPushRuntimeDisconnect(unittest.TestCase):
    def test_send_notification_entrypoint_is_deleted(self) -> None:
        self.assertFalse(hasattr(main.NewsAnalyzer, "_send_notification_if_needed"))
        self.assertFalse(hasattr(main, "LegacyPushRemovedError"))
